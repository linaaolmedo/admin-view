        ...
        <TabsContent value="templates" className="mt-6">
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-[#787878] mb-4">No saved report templates found.</p>
              <p className="text-sm text-gray-500">Create and save report templates to quickly generate recurring reports.</p>
            </CardContent>
          </Card>
        </TabsContent>
